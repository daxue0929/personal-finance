  ...
  <div style="height: 100%; display: flex; flex-direction: column;">
    <el-card style="flex: 1; margin: 20px; box-shadow: none; border: none; overflow: hidden;" :body-style="{ padding: '0', height: '100%', display: 'flex', flexDirection: 'column', overflow: 'hidden' }">
      ...
      <div style="padding: 20px; flex: 1; display: flex; flex-direction: column; overflow: hidden;">
        <el-table :data="buyers" style="width: 100%" height="100%" v-loading="loading" @sort-change="handleSortChange" :default-sort="defaultSort">
    ...
    >
      <el-form :model="quickBuyForm" label-width="100px">
        <el-form-item label="选择基金" required>
          <FundSelect v-model="quickBuyForm.fund_code" placeholder="请搜索选择基金" />
        </el-form-item>
